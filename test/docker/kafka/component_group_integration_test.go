...
func TestKafkaComponentGroup_Success(t *testing.T) {
	// Test parameters
...
func TestKafkaComponentGroup_FailAllRetries(t *testing.T) {
	// Test parameters
	numOfMessagesToSend := 100
	errAtIndex := 70
...
func TestKafkaComponentGroup_FailOnceAndRetry(t *testing.T) {
	// Test parameters
	numOfMessagesToSend := 100
