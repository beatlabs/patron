...
func TestKafkaAsyncPackageSimpleComponent_FailAllRetries(t *testing.T) {
	// Test parameters
	numOfMessagesToSend := 100
	errAtIndex := 50
	...
	numOfRetries := uint(3)
	component := newKafkaAsyncPackageSimpleComponent(t, failAllRetriesTopic1, numOfRetries, processorFunc)
...
func TestKafkaAsyncPackageSimpleComponent_FailOnceAndRetry(t *testing.T) {
	// Test parameters
	numOfMessagesToSend := 100
	...
	component := newKafkaAsyncPackageSimpleComponent(t, failAndRetryTopic1, 3, processorFunc)
