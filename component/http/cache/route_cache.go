...
func CachedExecutor(w http.ResponseWriter, r *http.Request, rc *RouteCache, handler http.Handler) (response *CacheHandlerResponse, e error) {
	req := toCacheHandlerRequest(r)
	return cacheHandler(handlerExecutor(w, r, func(writer http.ResponseWriter, request *http.Request) {
