...
This project is indexed by GitNexus as **patron** (3097 symbols, 6552 relationships, 265 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
